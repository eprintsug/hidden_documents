...
EPrints::Plugin::Screen::EPrint::HiddenDocument::Files

=cut

package EPrints::Plugin::Screen::EPrint::HiddenDocument::Files;
...
sub _render_filelist
{
	...
	push @fields, $session->dataset( "hidden_document" )->field( "main" );
